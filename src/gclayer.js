        ...
        _setMetadata: function(geojson) {
            this.metadata = {
                ...
                dataset: {
                    ...
                    datePublished: new Date(geojson.published),
                    feature_count: geojson.feature_count,
                    creator: geojson.author,
                    isBasedOnUrl: geojson.source,
                    url: "http://github.com/geoiq/gc_data/blob/master/datasets/" + geojson.id + ".geojson",
                    keywords: geojson.tags,
                    contributor: geojson.contributor,
                    fields: geojson.stats,
                    spatial: {geo: {polygon: geojson.extent.join(" ") + " " + geojson.extent[0]}}
                }
            };
        },
